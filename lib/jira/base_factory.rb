module JIRA
  ...
  class BaseFactory
    ...
    # list.
    delegate_to_target_class :all, :find, :collection_path, :singular_path, :jql, :get_backlog_issues, :get_board_issues, :get_sprints, :get_sprint_issues, :get_projects, :get_projects_full, , :revelio
