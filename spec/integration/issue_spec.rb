...
describe JIRA::Resource::Issue, type: :integration do
  with_each_client do |site_url, client|
    ...
    describe 'GET all issues' do # JIRA::Resource::Issue.all uses the search endpoint
      ...
      before do
        ...
        stub_request(:get, "#{site_url}/jira/rest/api/2/search/jql" \
                           '?expand=transitions.fields&maxResults=1000&startAt=11')
